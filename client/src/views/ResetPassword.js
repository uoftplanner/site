...
function ResetPassword(props) {
  ...
  if (IsLoading) {
    return (
      <Spinner size="xl" color="purple.500" m="10% auto" d="flex" alignItems="center" />
    );
  } else if (ValidLink) {
    return (
      <Formik
                      ...
                      <Field name="password">
                        {({field, form}) => (
                          <FormControl isInvalid={form.errors.password && form.touched.password} id="password" mt={2}>
                            ...
                            <Input {...field} focusBorderColor="purple.500" type="password" placeholder="New password" />
                      ...
                      <Field name="confirmPassword">
                        {({field, form}) => (
                          <FormControl isInvalid={form.errors.confirmPassword && form.touched.confirmPassword} id="confirmPassword" mt={2}>
                            ...
                            <Input {...field} focusBorderColor="purple.500" type="password" placeholder="Confirm new password" />
